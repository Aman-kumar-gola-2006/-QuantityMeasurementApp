...
public class OAuthAuthenticationSuccessHandler implements AuthenticationSuccessHandler {
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(OAuthAuthenticationSuccessHandler.class);

    private final JWTService jwtService;
    private final UserRepo userRepo;
    private final UserDetailsService userDetailsService;

    public OAuthAuthenticationSuccessHandler(JWTService jwtService, UserRepo userRepo, UserDetailsService userDetailsService) {
